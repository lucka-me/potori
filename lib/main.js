    ...
    redacted: {
        ...
        confirmation: function() {
            ...
            process.mails(
                ...
                function(fullMail) {
                    portalList.push(process.redacted.parse.all(fullMail));
                    count += 1;
                    return count;
                }
            );
        ...
        acceptance: function() {
            ...
            process.mails(
                ...
                function(fullMail) {
                    portalList.push(process.redacted.parse.all(fullMail, process.redacted.parse.acceptance));
                    count += 1;
                    return count;
                }
            );
        ...
        rejection: function() {
            ...
            process.mails(
                ...
                function(fullMail) {
                    portalList.push(process.redacted.parse.all(fullMail, process.redacted.parse.rejection));
                    count += 1;
                    return count;
                }
            );
        ...
        parse: {
            all: function(fullMail, additionalProcessForMailBody) {
                let portal = {
                ...
                for (let i = 0; i < fullMail.payload.headers.length; i++) {
                    ...
                    if (header.name === "Subject") {
                        portal.title = header.value.replace("Portal submission confirmation: ", "").replace("Portal review complete: ", "");
                        break;
                    }
                }
            ...
            rejection: function(mailBody, portal) {
                process.redacted.parse.lngLat(mailBody, portal);
                portal.resultTime = portal.confirmedTime;
                if (mailBody.search(value.string.mail.keyword.redacted.tooClose) > -1) {
                    portal.status = value.code.portalStatus.rejected.tooClose;
                } else if (mailBody.search(value.string.mail.keyword.redacted.duplicated) > -1) {
    ...
    prime: {
        ...
        confirmation: function() {
            ...
            process.mails(
                ...
                function(fullMail) {
                    portalList.push(process.prime.parse.all(fullMail));
                    count += 1;
                    return count;
                }
            );
        ...
        acceptance: function() {
            ...
            process.mails(
                ...
                function(fullMail) {
                    portalList.push(process.prime.parse.all(fullMail, process.prime.parse.acceptance));
                    count += 1;
                    return count;
                }
            );
        ...
        rejection: function() {
            ...
            process.mails(
                ...
                function(fullMail) {
                    portalList.push(process.prime.parse.all(fullMail, process.prime.parse.rejection));
                    count += 1;
                    return count;
                }
            );
            ...
            for (let i = 0; i < list.length; i++) {
                ...
                request.execute(function(fullMail) {
                    ...
                    if (count === list.length) {
                        ...
                        if (process.redacted.status[keys.type.mail].finished) {
