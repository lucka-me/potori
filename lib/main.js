...
const process = {
    ...
    redacted: {
        ...
        confirmation: function() {
            ...
            process.mails(
                ...
                ui.control.received,
                process.redacted.status.confirmation,
                function(fullMail) {
        ...
        acceptance: function() {
            ...
            process.mails(
                ...
                ui.control.portals.accepted,
                process.redacted.status.acceptance,
                function(fullMail) {
        ...
        rejection: function() {
            ...
            process.mails(
                ...
                ui.control.portals.rejected,
                process.redacted.status.rejection,
                function(fullMail) {
        ...
        parse: {
            ...
            acceptance: function(mailBody, portal) {
                toolkit.parseLngLat(mailBody, portal);
    ...
    mails: function(query, countUI, status, onGetMail) {

        status.finished = false;
        countUI.row.hidden = false;
        countUI.count.innerHTML = value.string.status.loading;
        ...
        let processMailList = function(list) {
            countUI.count.innerHTML = "0/" + list.length;
            for (let i = 0; i < list.length; i++) {
                ...
                request.execute(function(fullMail) {
                    ...
                    countUI.count.innerHTML = count + "/" + list.length;
