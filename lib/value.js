    ...
    string: {
        ...
        mail: {
            query: {
                ...
                prime: {
                    confirmation: 'from:nominations@portals.ingress.com subject:("能量塔提交確認" OR "Portal申請の受領確認" OR "Portal submission confirmation") -AP',
                    acceptance: "from:nominations@portals.ingress.com Intel Map AP",
                    rejection: 'from:nominations@portals.ingress.com subject:("能量塔審查完畢" OR "Portal審査の完了" OR "Portal review complete") -AP'
                },
            },
            keyword: {
                redacted: {
