dashboard.card.bs.card.reviews = {
    ...
    chart: null,
    init() {
        const canvasChart = elementKit.build('canvas', { class: 'canvas-chart--h' });
        this._root = elementKit.build('div', {
            class: 'mdc-card mdc-card--outlined padding--8 flex--3 flex-shrink--1',
            style: 'min-width:300px',
            children: [
                elementKit.build('span', {
                    class: 'mdc-typography--headline6',
                    innerHTML: 'Brainstorming Reviews',
                }),
                elementKit.build('div', {
