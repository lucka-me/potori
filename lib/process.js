...
import { BrainstormingKit } from "./bsKit.js";
...
window.process = {
    ...
    save() {
        ...
        fileKit.local.save(value.string.file.portals, this.blob.portals());
        window.setTimeout(() => {
            fileKit.local.save(value.string.file.bsData, this.blob.bsData());
        }, 2000);
    },
