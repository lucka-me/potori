        ...
        const contents = [
            ...
            eliKit.build('div', {
                ...
                children: [
                    ...
                    eliKit.build('div', { id: 'map-dialog-details' }),
                ],
            }),
        ];
    ...
    closed(event) {
        ...
        if (event.detail.action === 'save') {
            ...
            if (shouldUpdate) {
                ...
                ui.updateCard(this.portal, card);
                ui.updateLocation(this.portal, card);
                ui.updateCardVisibility(this.portal, card);
                dashboard.update();
            }
        }
    },
